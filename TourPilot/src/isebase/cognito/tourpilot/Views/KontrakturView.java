...
public class KontrakturView extends View {
	...
	private void initComponents() {
		...
		bodyImage = new ResizedImage(getResources(),
				isebase.cognito.tourpilot.R.drawable.body, 0, legendSize);
		images.add(bodyImage);		
		handsImage = new ResizedImage(getResources(),
				isebase.cognito.tourpilot.R.drawable.arms, 0, legendSize + bodyImage.getMatchHeight());
		images.add(handsImage);
		feetImage = new ResizedImage(getResources(),
				isebase.cognito.tourpilot.R.drawable.feet, 0, legendSize + bodyImage.getMatchHeight() + handsImage.getMatchHeight());
