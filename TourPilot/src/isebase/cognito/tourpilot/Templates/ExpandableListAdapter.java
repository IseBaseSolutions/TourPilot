...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(final int groupPosition, final int childPosition,
        ...
        TextView item = (TextView) convertView.findViewById(isebase.cognito.tourpilot.R.id.tvBradenAnswer);
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(isebase.cognito.tourpilot.R.layout.row_braden_question_template,
                    null);
        }
        TextView item = (TextView) convertView.findViewById(isebase.cognito.tourpilot.R.id.tvBradenQuestion);
